...
public class SearchController extends HttpServlet {
    ...
    private static final String searchResult = "searchResult.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Search")) {
                String category = request.getParameter("user_job");
                EventBean bean = new EventBean();
                bean.setCategory(category);
                List<EventDTO> list = bean.findByCategory();
                request.setAttribute("SEARCHRESULT", list);
                url = searchResult;
            } else if (action.equals("loadCategory")) {
                HttpSession session = request.getSession();
                CategoryBean cateBean = new CategoryBean();
                List<String> categoryList = cateBean.loadCategory();
