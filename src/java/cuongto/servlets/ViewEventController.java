...
public class ViewEventController extends HttpServlet {
    private static final String viewEvent = "viewEvent.jsp";
    private static final String update = "updateEvent.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(action.equals("Edit Event")){ //Edit event
                String eventid = request.getParameter("txtEventID");
                EventBean bean = new EventBean();
                bean.setEventid(eventid);
                EventDTO dto = bean.editEvent();
                request.setAttribute("DTO", dto);
                url = update;
            }else{
                EventBean bean = new EventBean();
                List<EventDTO> list = bean.viewEvent();
                request.setAttribute("viewEvent", list);
            }
